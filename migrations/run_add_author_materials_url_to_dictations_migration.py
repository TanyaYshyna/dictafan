...
Добавляет поле author_materials_url в таблицу dictations
"""
import os
import sys
...
def run_migration():
    """Выполняет SQL миграцию для добавления поля author_materials_url в таблицу dictations"""
    
    # Читаем SQL файл
    sql_file = project_root / 'migrations' / 'add_author_materials_url_to_dictations.sql'
    ...
    try:
        ...
        print("   Добавлено поле: author_materials_url в таблицу dictations")
...
if __name__ == '__main__':
    print("=" * 60)
    print("Миграция: добавление поля author_materials_url в dictations")
    print("=" * 60)
    print()
    ...
    if success:
        print()
        print("✅ Готово! Теперь можно использовать author_materials_url в коде.")
    else:
        print()
