#!/usr/bin/env python3
"""
Скрипт для выполнения миграции рефакторинга history_activity
Изменяет структуру таблицы для агрегации данных по дням
"""
import os
import sys
...
def run_migration():
    ...
    migration_file = project_root / 'migrations' / 'refactor_history_activity_to_daily.sql'
...
if __name__ == '__main__':
    print("=" * 60)
    print("Миграция: Рефакторинг history_activity для агрегации по дням")
    print("=" * 60)
    print()
