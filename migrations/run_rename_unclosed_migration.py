#!/usr/bin/env python3
"""
Скрипт для выполнения миграции переименования колонок в таблицах незавершенных диктантов
"""
import os
import sys
...
def run_migration():
    ...
    migration_file = project_root / 'migrations' / 'rename_unclosed_dictations_columns.sql'
...
if __name__ == '__main__':
    print("=" * 60)
    print("Миграция: Переименование колонок в таблицах незавершенных диктантов")
    print("=" * 60)
    print()
